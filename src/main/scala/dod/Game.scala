...
object Game extends JFXApp3 {
    ...
    override def start(): Unit = {
        ...
        val gameObject1 = GameObject(
            ...
            positionProperty = Some(PositionProperty(Position(coordinates = Coordinates(0, 0), direction = Direction.North), positionTimestamp = Timestamp(0))),
        ...
        val gameObject2 = GameObject(
            ...
            positionProperty = Some(PositionProperty(Position(coordinates = Coordinates(1, 0), direction = Direction.North), positionTimestamp = Timestamp(0))),
