...
class SpriteRepository {
    ...
    val spriteDataSeq: Seq[SpriteData] = Seq(
        SpriteData(id = 1, name = "sprite1", tileset = "tileset_32_01", x = 32 * 3, y = 0, width = 32, height = 32),
        SpriteData(id = 2, name = "sprite2", tileset = "tileset_32_01", x = 32, y = 32, width = 32, height = 32),
